...
namespace ICSharpCode.AvalonEdit.Editing
{
    ...
    public sealed class Caret
    {
        ...
        void ShowInternal()
        {
            ...
            if (caretAdorner != null && textView != null)
            {
                ...
                if (visualLine != null)
                {
                    ...
                    {
                        CaretRectangle = caretRect,
                        CursorMode = CaretMode,
                        Offset = Offset,
                        TextView = textView,
                        Column = Column,
                        VisualLine = visualLine
                    };
                    caretAdorner.Show(args);
                }
                else
                {
                    caretAdorner.Hide();
        ...
        /// <summary>
        /// Gets/Sets the pen used to draw the caret.
        /// </summary>
        public Pen CaretPen
        {
            get { return caretAdorner.CaretPen; }
            set { caretAdorner.CaretPen = value; }
        }

        public CursorMode CaretMode { get; set; }
    }
}
